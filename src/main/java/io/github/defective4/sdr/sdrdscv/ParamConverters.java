...
public class ParamConverters {
    ...
    static {
        CONVERTERS.putAll(Map.of(String[].class, e -> e.split(","), Color.class, Color::decode, char.class,
                str -> str.charAt(0), int.class, Integer::parseInt, long.class, Long::parseLong, float.class,
